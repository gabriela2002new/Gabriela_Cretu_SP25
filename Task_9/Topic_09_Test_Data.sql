...
-----------------------------------------------------------------------------------------------
CALL bl_cl.sp_run_batch_etl_by_day(DATE '2022-01-05', DATE '2022-04-05');---excluding the dm_fct_sales


CALL bl_dm.load_fct_sales_rolling_window(DATE '2021-01-05', DATE '2021-04-05',TRUE);---with partitions insode eac loop
CALL bl_dm.load_fct_sales_rolling_window(DATE '2021-01-05', DATE '2021-04-05', FALSE);----no partitions
...
--------------------------------------------------------------------------------------------------------------------------------------------------
CALL bl_dm.load_fct_sales_rolling_window(DATE '2021-01-05', DATE '2021-04-05', TRUE);---with partitions
CALL bl_dm.load_fct_sales_rolling_window(DATE '2021-01-05', DATE '2021-04-05', FALSE);----no partitions
