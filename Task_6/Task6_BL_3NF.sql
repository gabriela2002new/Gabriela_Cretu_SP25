...
CREATE TABLE IF NOT EXISTS bl_3nf.CE_CUSTOMERS_SCD (
    ...
    CUSTOMER_REGISTRATION_DT_ID INT,
...
-- Game Types
-- ======================================
INSERT INTO bl_3nf.ce_game_types VALUES (-1, 'n. a.', 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Game Categories
-- ======================================
INSERT INTO bl_3nf.ce_game_categories VALUES (-1, 'n. a.', -1, -1, -1, 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;
...
INSERT INTO bl_3nf.ce_game_numbers VALUES (
  -1, 'n. a.', -1, DATE '1900-01-01', 'n. a.', -1, -1, -1, -1,
...
-- States
-- ======================================
INSERT INTO bl_3nf.ce_states VALUES (-1, 'n. a.', 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Cities
-- ======================================
INSERT INTO bl_3nf.ce_cities VALUES (-1, 'n. a.', -1, 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Zip Codes
-- ======================================
INSERT INTO bl_3nf.ce_zip VALUES (-1, 'n. a.', -1, 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Location Names
-- ======================================
INSERT INTO bl_3nf.ce_location_names VALUES (-1, 'n. a.', -1, 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Retailer License Numbers
-- ======================================
INSERT INTO bl_3nf.ce_retailer_license_numbers VALUES (-1, 'n. a.', -1, 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Statuses
-- ======================================
INSERT INTO bl_3nf.ce_statuses VALUES (-1, 'n. a.', 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;

-- ======================================
-- Departments
-- ======================================
INSERT INTO bl_3nf.ce_departments VALUES (-1, 'n. a.', 'MANUAL', 'MANUAL', DATE '1900-01-01', DATE '1900-01-01');
COMMIT;
...
INSERT INTO bl_3nf.ce_customers_scd VALUES (
  -1, 'n. a.', -1, -1, 'n. a.', 'n. a.', DATE '1900-01-01', 'n. a.', 'n. a.',
