...
WITH new_game_numbers AS (
    SELECT DISTINCT ON (COALESCE(s.game_number::VARCHAR, d.game_number::VARCHAR))
        ...
        COALESCE(d.draw_dt::DATE, '1900-01-01') AS draw_dt,
...
select * from ce_game_categories cgc ;
-- ======================================
-- Payment Methods
-- ======================================
...
combined_employees AS (
    SELECT
        ...
        COALESCE(d.employee_hire_dt::DATE,  '1900-01-01') AS employee_hire_dt,
...
mapped_customers AS (
    SELECT
        ...
        COALESCE(cc.customer_registration_dt::DATE,  '1900-01-01') AS customer_registration_dt,
...
SELECT
    ...
    COALESCE(CAST(s.transaction_dt AS DATE),  '1900-01-01'),
